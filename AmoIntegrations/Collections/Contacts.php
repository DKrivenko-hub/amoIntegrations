...
class Contacts implements IEntity
{
    ...
    {
        return EEntityTypes::Contacts->value;
    }
    ...
    public function find($key, $value)
    {
        ...
        foreach ($this->data['custom_fields_values'] as $cfv) {
            if ($cfv['field_id'] == $this->amoSettings->contacts['cfv']['textfields'][$key]) {
